    ...
    public void apply(Map<String, Object> networkConfiguration) throws DBusException {
        ...
        for (String iface : netInterfaces) {
            ...
            if (deviceType == NMDeviceType.NM_DEVICE_TYPE_WIFI) {
                ...
                Map<String, Variant<?>> wifiSettingsMap = NMSettingsConverter.build802_11_WirelessSettings(networkConfiguration, iface);
                Map<String, Variant<?>> wifiSecuritySettingsMap = NMSettingsConverter.build802_11_WirelessSecuritySettings(networkConfiguration, iface);
