    ...
    public void apply(Map<String, Object> networkConfiguration) throws DBusException {
        ...
        for (String iface : netInterfaces) {
            ...
            if (deviceType == NMDeviceType.NM_DEVICE_TYPE_WIFI) {
                ...
                Map<String, Variant<?>> wifiSettingsMap = NMSettingsConverter.build80211WirelessSettings(networkConfiguration, iface);
                Map<String, Variant<?>> wifiSecuritySettingsMap = NMSettingsConverter.build80211WirelessSecuritySettings(networkConfiguration, iface);
